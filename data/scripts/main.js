...
auth.onAuthStateChanged(user => {
    if (user) {
        ...
        function d() {
            var C = ['e003:\x20Ada\x20elemen\x20yang\x20kamu\x20ganti!', 'connect', 'innerHTML', 'loadSpin', 'style', 'e002:\x20Ada\x20elemen\x20penting\x20yang\x20kamu\x20ganti!', 'none', 'e001:\x20Ada\x20elemen\x20penting\x20yang\x20kamu\x20hapus!', '26PmQaEO', '12392LbtwXf', 'inside', '72422qpmqIU', 'Template\x20by\x20DanSka', '&lt;\x20DanSka\x20/&gt;', '366lFGPmc', 'display', '1987264OaEdSL', '12dtCspK', '9785450CSNobP', '291310RZUtsg', 'getElementById', 'innerText', '36HGlxKq', 'wmName', '36677828XOUFVt', '1387946xOxSDP'];
            d = function () {
                return C;
            };
            return d();
        ...
        function r(Y, A) {
            ...
            if (Y[a(0x132)] != 'Template\x20by\x20DanSka') return A['innerHTML'] = a(0x130);
